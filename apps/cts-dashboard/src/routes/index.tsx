...
const privateRoutes: PrivateRoute[] = [
    ...
    { path: '/refund-resend', component: loadPage(() => import("../pages/dashboard/Refund/Refund")), permission: P.REFUND_ACCESS },
    ...
    { path: '/refund', component: loadPage(() => import("../pages/dashboard/Reports/Refund")), permission: P.REFUND_ACCESS },
    { path: '/resend', component: loadPage(() => import("../pages/dashboard/Reports/Resend")), permission: P.RESEND_ACCESS },
